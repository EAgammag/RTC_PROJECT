        ...
        <form method="POST" action="{{ route('admin.users.store') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           class="w-full px-4 py-2.5 rounded-lg text-sm text-slate-200"
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1.5">Student / Service ID</label>
                    <input type="text" name="student_id" value="{{ old('student_id') }}" required maxlength="50"
                           class="w-full px-4 py-2.5 rounded-lg text-sm text-slate-200 font-mono"
                           style="background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.15);"
                           placeholder="e.g. 2024-00001">
                    @error('student_id') <p class="mt-1 text-xs text-red-400">{{ $message }}</p> @enderror
                </div>
            ...
            <div class="flex gap-3 mt-6">
                ...
                <a href="{{ route('admin.dashboard') }}"
                   class="px-6 py-2.5 rounded-lg text-sm font-medium text-slate-300 transition-colors"
