...
<body class="font-sans antialiased">
    ...
    <section class="hero-bg dot-grid relative min-h-screen flex flex-col justify-center pt-24 pb-20 px-6 overflow-hidden">
        ...
        <div class="absolute bottom-20 left-0 pointer-events-none select-none hidden xl:block"
             style="opacity: 0.028; transform: translateX(-8%);"
        >
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    @else
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <a href="#access-tiers" class="btn-ghost">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex flex-col gap-5 lg:pl-8">
                    ...
                    <div class="p-4 flex items-center gap-4 rounded-xl"
                         style="background: rgba(6,12,20,.82); border: 1px solid rgba(52,211,153,.28); box-shadow: 0 2px 16px rgba(0,0,0,.45), inset 0 1px 0 rgba(255,255,255,.04);">
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                             style="background: rgba(52,211,153,.13); border: 1px solid rgba(52,211,153,.28);">
                            <svg class="w-5 h-5" fill="none" stroke="#34d399" viewBox="0 0 24 24" stroke-width="1.8">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14M12 5l7 7-7 7"/>
                            </svg>
                        </div>
                        <div>
                            <div class="flex items-center gap-2">
                                <span class="w-1.5 h-1.5 rounded-full bg-emerald-400" style="box-shadow: 0 0 6px #34d399;"></span>
                                <p class="text-sm font-semibold text-emerald-400">All Systems Operational</p>
                            </div>
                            <p class="text-sm text-slate-300 mt-0.5">Authentication &middot; Records &middot; Session Control</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50 z-10">
            <p class="text-xs text-slate-300 tracking-widest uppercase">Scroll</p>
